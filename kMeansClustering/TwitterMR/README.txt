K-Means clustering on Twitter Follower data - Using Hadoop MapReduce
CS6240 Fall 2018 HW4
=================================================
...
5) Update the following variables in the Makefile to customize according to your setup:
    ...
    hdfs.user.name, 
    aws.bucket.name,
    kValue : set this as the number of centroids for kmeans
...
Output folders for the centroids after each iteration are created in the same /TwitterMR/ directory.
